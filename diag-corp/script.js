...
const APP_META = Object.freeze({
  ...
  storageKey: "monyu-diagnostico-v4",
});
...
const PARAMETERS = Object.freeze({
  ...
  funding: {
    nonReimbursableByStage: {
      ideacao: { cap: 500000, label: "Ideação" },
      validacao: { cap: 3000000, label: "Validação" },
      operacao: { cap: 5000000, label: "Operação" },
      tracao: { cap: 10000000, label: "Tração" },
      escala: { cap: 50000000, label: "Escala" },
    },
    embrapiiReferenceRate: 0.33,
    creditReferenceRate: 0.7,
    equityTicketByStage: {
      ideacao: { value: 150000, label: "Ideação / anjo" },
      validacao: { value: 500000, label: "Validação / pré-seed" },
      operacao: { value: 2000000, label: "Operação / seed" },
      tracao: { value: 15000000, label: "Tração / Série A" },
      escala: { value: 40000000, label: "Escala / Série B+" },
    },
  },
  ranges: {
    innovationSpend: {
    ...
    fundingProjectBudget: {
      ate_300k: { min: 0, max: 300000, label: "Até R$ 300 mil" },
      de_300k_1m: { min: 300000, max: 1000000, label: "R$ 300 mil a R$ 1 mi" },
      de_1m_5m: { min: 1000000, max: 5000000, label: "R$ 1 mi a R$ 5 mi" },
      de_5m_20m: { min: 5000000, max: 20000000, label: "R$ 5 mi a R$ 20 mi" },
      acima_20m: { min: 20000000, max: null, label: "Acima de R$ 20 mi" },
    },
  },
});
...
const QUESTION_BANK = Object.freeze([
  ...
  },
  {
    ...
    options: [
      choice("ideacao", "Ideação", "A oportunidade ainda está sendo estruturada", "01"),
      choice("validacao", "Validação", "Há protótipo, testes ou prova de conceito", "02", "orange"),
      choice("operacao", "Operação", "A solução entrou em uso ou em primeiros contratos", "03", "yellow"),
      choice("tracao", "Tração", "Há sinais consistentes de mercado e crescimento", "04", "orange"),
      choice("escala", "Escala", "A prioridade é expandir capacidade e alcance", "05", "yellow"),
  ...
  {
    id: "orcamento_projeto_credito",
    order: 32,
    stage: 5,
    section: "TRILHA: FUNDING E FOMENTO",
    title: "Qual é o orçamento estimado do projeto que precisaria financiar?",
    help: "Usaremos apenas para aproximar a parcela financiável. Não é uma proposta de crédito.",
    type: "single",
    category: "priorizacao",
    condition: "credit_budget_track",
    options: [
      choice("ate_300k", "Até R$ 300 mil", "Projeto de menor porte", "300k"),
      choice("de_300k_1m", "R$ 300 mil a R$ 1 milhão", "Projeto em estruturação", "1M", "orange"),
      choice("de_1m_5m", "R$ 1 milhão a R$ 5 milhões", "Projeto relevante", "5M", "yellow"),
      choice("de_5m_20m", "R$ 5 milhões a R$ 20 milhões", "Investimento estruturado", "20M", "orange"),
      choice("acima_20m", "Acima de R$ 20 milhões", "Projeto de grande porte", "20M+", "yellow"),
      choice("nao_sei", "Ainda não sei", "Mostraremos o caminho sem estimativa de valor", "?"),
    ],
  },
  {
    id: "apetite_equity",
...
const MECHANISM_META = Object.freeze({
  ...
  STARTUPLC182: { name: "Capital de risco e Marco Legal das Startups", source: LEGAL_SOURCES.STARTUPLC182 },
